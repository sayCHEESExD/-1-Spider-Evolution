...
export class TouchControls {
  ...
  constructor(look: LookSink) {
    ...
    this.jumpButton.setAttribute('aria-label', 'Jump (press again in the air to web-swing)');
    ...
    this.attackButton.setAttribute('aria-label', 'Shoot web');
    this.attackButton.innerHTML = '<span>WEB</span>';
