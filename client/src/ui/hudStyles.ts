...
.aoe-panel__close {
  ...
  line-height: 1;
  cursor: pointer;
  box-shadow: 0 3px 0 rgba(0, 0, 0, 0.3), 0 0 10px rgba(255, 40, 50, 0.5);
  display: grid;
  place-items: center;
  padding: 0;
}
.aoe-panel__close .sp-x { width: 72%; height: 72%; }
.aoe-panel__close:hover { filter: brightness(1.1); box-shadow: 0 3px 0 rgba(0, 0, 0, 0.3), 0 0 16px rgba(255, 50, 60, 0.8); }
.aoe-panel__close:hover .sp-x { transform: rotate(90deg); }
.aoe-panel__body {
