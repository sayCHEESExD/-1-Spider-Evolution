 ...
 *
 * So a suit is a small pure function (`SuitPainter`) instead of an image file:
 * a web pattern, a spider emblem or a lens outline is a few lines of maths,
 * costs no download, and lands on the right texels of the real model's UVs.
 */
